<div class="container">
	<div class="well">
				 	...
				 	<div class="row">
						...
						<div class="form-group col-md-6">
				 		...
				 		<div class="col-md-2">
							...
							<input type="hidden" name="action" id="action" value="areawiseduelist">
		...
		<div class="row">
			<div class="col-md-12">
				<div style="margin-bottom: 15px"><a href="<?php echo base_url('areawise-due-print') ?>" target="_blank" style="color:#000;font-size: 16px;"><i class="fa fa-print"></i> print</a></div>
...
<script>
	$(document).ready(function(){
	      ...
	      $.ajax({
	        url:'<?php echo base_url("areawise-cust-due") ?>',
	        method:'post',
	        data:new FormData(this),
	        contentType:false,
	        processData:false,
	        success:function(data){
	          $('#areawiseduelist').html(data);
	        }
	      });
	    }
	   })
