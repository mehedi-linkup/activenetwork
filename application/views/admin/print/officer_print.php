...
<body style="background:none;">
  <!-----------------    Print Type -- POS      ------------>
    ...
    <table  cellspacing="0" cellpadding="0" width="100%" style="padding-bottom: 10px">
        <tr>
            <td colspan="2" class="invoice-title"><strong style="font-size:16px;">Officer Collection Amount</strong></td>
        </tr>
    </table>
    ...
    <table id="order-print">
        <tr>
           ...
           <th style="text-align:center;">Officer Id</th>
        ...
        <?php
        	...
        	if ($officercollection){ 
        		foreach ($officercollection as  $value) {
