  ...
  <!-----------------    Print Type -- POS      ------------>
    ...
    <table id="order-print">
        <tr>
           ...
           <th style="text-align:center; padding:3px 0px;width: 15%;">Month</th>
           <th style="text-align:center; padding:3px 0px">Dish Payment</th>
           <th style="text-align:center; padding:3px 0px">Wifi Payment</th>
           <th style="text-align:center; padding:3px 0px">Total Payment</th>
        </tr>
        <?php
            ...
            foreach ($areaWiseCustomers as $value) {
              ...
              $subTotal = $value->dish_bill + $value->wifi_bill;
                ...
                <tr align="center">
                    ...
                    <td><?php echo $value->dish_bill ?></td>
                    <td><?php echo $value->wifi_bill ?></td>
            ...
            <tr>
                ...
                <td style="border:0px; text-align: center;padding-top: 10px"><?php echo $dish ?> </td>
                <td style="border:0px; text-align: center;padding-top: 10px"><?php echo $wifi ?> </td>
