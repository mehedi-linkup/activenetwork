...
<body style="background:none;">
  ...
  <!-----------------    Print Type -- POS      ------------>
    ...
    <table id="order-print">
        ...
        <tr>
          <td colspan="4" style="border:0px;text-align: right;">Opening Balance : </td>
          <td style="border:0px; text-align: center;padding: 0px !important"><?php echo $openingBalance ?> </td>
        </tr>
        <tr>
          <hr class="bg">
          <td colspan="4" style="border:0px;text-align: right;">Sub Total : </td>
          <td style="border:0px; text-align: center;padding: 0px !important"><?php echo $subtotal=($sum + $openingBalance -$discount); ?> </td>
        </tr>
    </table>
  </div>
</body>
